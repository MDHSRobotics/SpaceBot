...
public class Devices {
    ...
    public static final WPI_TalonSRX talonSrxHatcher = new WPI_TalonSRX(9); // 1 motor ID 9
    ...
    public static final WPI_TalonSRX talonSrxTank = new WPI_TalonSRX(2); // 1 motor ID 1
